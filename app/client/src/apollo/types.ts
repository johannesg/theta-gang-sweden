...
export type OptionsQuery = { __typename?: 'Query', matrix: { __typename?: 'OptionsMatrix', underlying: { __typename?: 'InstrumentDetails', name: string, href: string, change: number | null, changePercent: number | null, lastPrice: number | null, buyPrice: number | null, sellPrice: number | null, highestPrice: number | null, lowestPrice: number | null, updated: string | null, totalVolumeTraded: number | null } | null, matrix: Array<{ __typename?: 'OptionsWithExpiry', expires: string, options: Array<{ __typename?: 'OptionMatrixItem', strike: number | null, call: { __typename?: 'OptionDetails', name: string | null, href: string | null, type: CallOrPutType | null, strike: number | null, changePercent: number | null, change: number | null, updated: string | null, bid: number | null, ask: number | null, spread: number | null, last: number | null, high: number | null, low: number | null, volume: number | null, expires: string | null, optionType: OptionType | null, parity: number | null, delta: number | null, theta: number | null, vega: number | null, gamma: number | null, rho: number | null, IV: number | null } | null, put: { __typename?: 'OptionDetails', name: string | null, href: string | null, type: CallOrPutType | null, strike: number | null, changePercent: number | null, change: number | null, updated: string | null, bid: number | null, ask: number | null, spread: number | null, last: number | null, high: number | null, low: number | null, volume: number | null, expires: string | null, optionType: OptionType | null, parity: number | null, delta: number | null, theta: number | null, vega: number | null, gamma: number | null, rho: number | null, IV: number | null } | null }> }> } | null };
...
export type DetailsQuery = { __typename?: 'Query', optionDetails: { __typename?: 'OptionDetails', name: string | null, href: string | null, type: CallOrPutType | null, strike: number | null, changePercent: number | null, change: number | null, updated: string | null, bid: number | null, ask: number | null, spread: number | null, last: number | null, high: number | null, low: number | null, volume: number | null, expires: string | null, optionType: OptionType | null, parity: number | null, delta: number | null, theta: number | null, vega: number | null, gamma: number | null, rho: number | null, IV: number | null } | null };

export type InstrumentDetailsFragment = { __typename?: 'InstrumentDetails', name: string, href: string, change: number | null, changePercent: number | null, lastPrice: number | null, buyPrice: number | null, sellPrice: number | null, highestPrice: number | null, lowestPrice: number | null, updated: string | null, totalVolumeTraded: number | null };

export type OptionDetailsFragment = { __typename?: 'OptionDetails', name: string | null, href: string | null, type: CallOrPutType | null, strike: number | null, changePercent: number | null, change: number | null, updated: string | null, bid: number | null, ask: number | null, spread: number | null, last: number | null, high: number | null, low: number | null, volume: number | null, expires: string | null, optionType: OptionType | null, parity: number | null, delta: number | null, theta: number | null, vega: number | null, gamma: number | null, rho: number | null, IV: number | null };
